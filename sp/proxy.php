...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <head>
        ...
        <title>Twindexator - Proxies</title>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(function() {
                ...
                $( "#add-accs-dialog" ).dialog({
                    ...
                    buttons: {
                        "Add": function() {
                            ...
                            $.post("./includes/actions.php", { data: list, act: "add", type: "proxy"},
                            function(data){
                ...
                $( "#dialog-confirm" ).dialog({
                    ...
                    autoOpen: false,
                    buttons: {
                        "Delete proxies": function() {
                            var an = $("#fnSel").attr('value'); 
                            $( this ).dialog( "close" ); 
                            $.post("./includes/actions.php", { data: an, act: "delete", type: "proxy"},
                            function(data){
                                $("#showMessage").html(data);
                                location.reload();
                                $("#showMessage").css({display: "block"});
                ...
                $( ".remove" ).click(function() {
                    $( ".ui-dialog-title" ).text('Delete selected proxies?');
                    $( "#dialog-confirm p").text('You\'re going to delete selected proxies.');
                    $( "#dialog-confirm" ).dialog( "open" );
                    return false;
                });
                $( ".delete" ).click(function() {
                    $("#fnSel").attr('value', "-1");
                    $( ".ui-dialog-title" ).text('Delete all proxies in database?');
                    $( "#dialog-confirm p").text('This will delete at once all proxies you have.');
                    $( "#dialog-confirm" ).dialog( "open" );
                    return false;
                });
                ...
                $(document).ready(function() {
                    ...
                    oTable = $('#example').dataTable( {
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": "./includes/dataJSON.php?table=proxy",
                        "bAutoWidth": true,
                        "bShowFilter": false,
                        ...
                        "fnDrawCallback": function() {
                            $('.editable', this.fnGetNodes()).editable('./includes/actions.php', {
                                ...
                                "submitdata": function (value,settings ) {
                                    ...
                                    return {"recId":aData[0],"act":"update", "type" : "proxy"};
                                },
    ...
    <body id="indexBody">
        ...
        <div id="add-accs-dialog" title="Add proxies">
            <form>
                                                    ...
                                                    <div class="bind-indent">
                                                        ...
                                                        <div class="row">
                                                            <div id="globalNav">
                                                                <ul>
                                                                    <li>
                                                                        <a href="./index.php">Tasks<span></span></a>
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <div class="wrapper">
                                                            ...
                                                            <div id="nav-links">
                                                                ...
                                                                <a class="add" href="#" title="add new proxies">add</a>
                                                                <a class="remove" href="#" title="remove selected">remove</a>
                                                                <a class="delete" href="#" title="delete all">delete all</a>
                                                                <a class="export" href="./includes/actions.php?act=export&amp;what=proxy" target="_blank" title="get proxies as list">export</a>
